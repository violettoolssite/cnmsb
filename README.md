...
### **300+ 命令支持 | 智能内联补全 | 交互式选择器 | 历史命令模式 | 内置编辑器 | SQL Shell | AI 智能补全 [NEW]**
...
- **AI 大模型补全 [NEW]**：按 Alt+L 触发，接入 Qwen2.5-Coder 大模型，理解你的意图生成完整命令。
...
**这是最新加入的功能！** 按 **Alt+L** 触发，接入大语言模型（默认 Qwen2.5-Coder-32B），理解你的意图并生成完整的命令建议。
...
**这个功能有什么用？**
- 不确定具体参数？AI 帮你生成完整命令
- 想实现某个功能但不知道命令？用自然语言描述，AI 给你建议
- 支持自定义 API，可以用任何兼容 OpenAI 格式的服务
...
详细配置见下方 [AI 智能补全](#ai-智能补全可选功能) 章节。
