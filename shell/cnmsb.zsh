...
_cnmsb_ai_complete() {
    ...
    # 显示正在调用 AI 的提示
    echo ""
    echo "\033[1;48;5;53m\033[38;5;213m ╭─────────────────────────────────╮ \033[0m"
    echo "\033[1;48;5;53m\033[38;5;213m │  🤖 AI 智能补全 - 正在思考...  │ \033[0m"
    echo "\033[1;48;5;53m\033[38;5;213m ╰─────────────────────────────────╯ \033[0m"
    ...
    # 清除提示
    echo -ne "\033[4A\033[J"
    
    if [[ $ret -ne 0 ]]; then
        echo ""
        echo "\033[1;31m╭─ 🤖 AI 补全失败 ─╮\033[0m"
        echo "\033[31m$completions\033[0m"
        echo ""
        zle reset-prompt
        return
    fi
    ...
    echo ""
    echo "\033[1;48;5;53m\033[38;5;213m ╭─────────────────────────────────╮ \033[0m"
    echo "\033[1;48;5;53m\033[38;5;213m │     🤖 AI 智能补全建议         │ \033[0m"
    echo "\033[1;48;5;53m\033[38;5;213m ╰─────────────────────────────────╯ \033[0m"
    echo ""
    ...
    if [[ "$choice" =~ ^[1-9]$ ]] && (( choice <= ${#items[@]} )); then
        ...
        CURSOR=${#BUFFER}
        echo ""
        echo "\033[1;32m✓ 已应用: ${items[$choice]}\033[0m"
    else
        echo ""
...
print -P "%F{208}cnmsb%f 已加载 (输入 \x1b[38;5;226mcnmsb\x1b[0m 查看帮助)"
print -P "  %F{226}Tab%f=补全  %F{46}↑↓%f=切换  %F{51}→%f=接受  %F{201}?%f=帮助  %F{196}Esc%f=取消"
print -P "  %F{245}Alt+H%f=历史命令  %F{135}Alt+L%f=🤖AI智能补全"
